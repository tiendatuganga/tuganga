...
export function GradientWave({
  horizonColor = DEFAULT_PROPS.horizonColor,
  waveColor = DEFAULT_PROPS.waveColor,
  crestColor = DEFAULT_PROPS.crestColor,
  speed = DEFAULT_PROPS.speed,
  amplitude = DEFAULT_PROPS.amplitude,
  waveScale = DEFAULT_PROPS.waveScale,
  waveRatio = DEFAULT_PROPS.waveRatio,
  swell = DEFAULT_PROPS.swell,
  turbulence = DEFAULT_PROPS.turbulence,
  tilt = DEFAULT_PROPS.tilt,
  zoom = DEFAULT_PROPS.zoom,
  height = DEFAULT_PROPS.height,
  fogDepth = DEFAULT_PROPS.fogDepth,
  ...
  parallaxStrength = DEFAULT_PROPS.parallaxStrength,
  ...
  useEffect(() => {
    ...
    ctxMap.set(container, { program, mesh });
  ...
  useEffect(() => {
    ...
    const program = ctxMap.get(container)?.program;
    if (!program) return;
  ...
  return (
    <div
      ref={containerRef}
      className={["relative h-full w-full overflow-hidden", className].join(" ").trim()}
    />
  );
}

const ctxMap = new WeakMap<HTMLDivElement, { program: Program; mesh: Mesh }>();